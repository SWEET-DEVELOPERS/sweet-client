...
export const isTokenExist = (): boolean => {
  const token = localStorage.getItem(
    'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJzdWIiOiIxIiwiaWF0IjoxNzA1NjQ5NjkxLCJleHAiOjE3MDYyNTQ0OTF9.LfkqgbqIYgD1gc6SyNBUUkL4VA_oxpVcEzj0xGqvwec',
  ); // 'yourTokenKey'는 실제 사용하는 토큰의 키로 대체하세요
  return !!token;
};
